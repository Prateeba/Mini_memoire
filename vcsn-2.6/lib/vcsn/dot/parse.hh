...
/**
 ** \file /Users/akim/src/lrde/2/lib/vcsn/dot/parse.hh
 ** Define the vcsn::detail::dot::parser class.
 */

// C++ LALR(1) parser skeleton written by Akim Demaille.

#ifndef YY_YY_USERS_AKIM_SRC_LRDE_2_LIB_VCSN_DOT_PARSE_HH_INCLUDED
# define YY_YY_USERS_AKIM_SRC_LRDE_2_LIB_VCSN_DOT_PARSE_HH_INCLUDED
// //                    "%code requires" blocks.
#line 17 "/Users/akim/src/lrde/2/lib/vcsn/dot/parse.yy" // lalr1.cc:377
...
#line 89 "/Users/akim/src/lrde/2/lib/vcsn/dot/parse.hh" // lalr1.cc:377
...
#line 11 "/Users/akim/src/lrde/2/lib/vcsn/dot/parse.yy" // lalr1.cc:377
namespace vcsn { namespace detail { namespace dot {
#line 166 "/Users/akim/src/lrde/2/lib/vcsn/dot/parse.hh" // lalr1.cc:377
  ...
  basic_symbol (typename Base::kind_type t, const string_t v, const location_type& l);
    ...
    static inline
    symbol_type
    make_ID (const string_t& v, const location_type& l);
    ...
    , location (other.location)
  {
    ...
    {
      case 31: // path
        value.copy< paths_t > (other.value);
        break;
      ...
      case 32: // edge_stmt
      case 36: // subgraph
        value.copy< states_t > (other.value);
        break;
      ...
      case 34: // node_id
      case 37: // id.opt
        value.copy< string_t > (other.value);
        break;
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const paths_t v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const states_t v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const string_t v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  parser::basic_symbol<Base>::clear ()
  {
   ...
   default:
    ...
    {
      case 31: // path
        value.template destroy< paths_t > ();
        break;
      ...
      case 32: // edge_stmt
      case 36: // subgraph
        value.template destroy< states_t > ();
        break;
  ...
  parser::symbol_type
  parser::make_DIGRAPH (const location_type& l)
  {
    return symbol_type (token::DIGRAPH, l);
  }

  parser::symbol_type
  parser::make_EDGE (const location_type& l)
  {
    return symbol_type (token::EDGE, l);
  }

  parser::symbol_type
  parser::make_GRAPH (const location_type& l)
  {
    return symbol_type (token::GRAPH, l);
  }

  parser::symbol_type
  parser::make_NODE (const location_type& l)
  {
    return symbol_type (token::NODE, l);
  }

  parser::symbol_type
  parser::make_SUBGRAPH (const location_type& l)
  {
  ...
  parser::symbol_type
  parser::make_ID (const string_t& v, const location_type& l)
  {
...
#line 1192 "/Users/akim/src/lrde/2/lib/vcsn/dot/parse.hh" // lalr1.cc:377


// //                    "%code provides" blocks.
#line 63 "/Users/akim/src/lrde/2/lib/vcsn/dot/parse.yy" // lalr1.cc:377

  #define YY_DECL_(Class) \
    parser::symbol_type Class lex(driver& driver_)
  #define YY_DECL YY_DECL_(yyFlexLexer::)

#line 1202 "/Users/akim/src/lrde/2/lib/vcsn/dot/parse.hh" // lalr1.cc:377


#endif // !YY_YY_USERS_AKIM_SRC_LRDE_2_LIB_VCSN_DOT_PARSE_HH_INCLUDED
