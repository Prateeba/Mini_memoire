...
static const YY_CHAR yy_ec[256] =
    {   0,
       ...
       16,   16,   16,   16,   16,   16,   16,   16,   16,   16,
       17,   18,   19,    1,   16,    1,   20,   21,   16,   22,

       23,   16,   24,   25,   26,   16,   16,   16,   16,   27,
       28,   29,   16,   30,   31,   16,   32,   16,   16,   16,
       16,   16,   33,    1,   34,    1,    1,   16,   16,   16,
       16,   16,   16,   16,   16,   16,   16,   16,   16,   16,
       16,   16,   16,   16,   16,   16,   16,   16,   16,   16,
       16,   16,   16,   16,   16,   16,   16,   16,   16,   16,
       16,   16,   16,   16,   16,   16,   16,   16,   16,   16,
...
#line 1 "lib/vcsn/dot/scan.ll"
/* See <http://www.graphviz.org/content/dot-language>. */
#define YY_NO_INPUT 1

#line 14 "lib/vcsn/dot/scan.ll"
#include <string>
#include <iostream>
...
#line 568 "lib/vcsn/dot/scan.cc"

#line 570 "lib/vcsn/dot/scan.cc"
...
#line 41 "lib/vcsn/dot/scan.ll"


#line 44 "lib/vcsn/dot/scan.ll"
...
case 1:
YY_RULE_SETUP
#line 53 "lib/vcsn/dot/scan.ll"
return TOK(DIGRAPH);
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 54 "lib/vcsn/dot/scan.ll"
return TOK(EDGE);
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 55 "lib/vcsn/dot/scan.ll"
return TOK(GRAPH);
	YY_BREAK
case 4:
YY_RULE_SETUP
#line 56 "lib/vcsn/dot/scan.ll"
return TOK(NODE);
	YY_BREAK
case 5:
YY_RULE_SETUP
#line 57 "lib/vcsn/dot/scan.ll"
return TOK(SUBGRAPH);
	YY_BREAK
case 6:
YY_RULE_SETUP
#line 58 "lib/vcsn/dot/scan.ll"
return TOK(LBRACE);
	YY_BREAK
case 7:
YY_RULE_SETUP
#line 59 "lib/vcsn/dot/scan.ll"
return TOK(RBRACE);
	YY_BREAK
case 8:
YY_RULE_SETUP
#line 60 "lib/vcsn/dot/scan.ll"
return TOK(LBRACKET);
	YY_BREAK
case 9:
YY_RULE_SETUP
#line 61 "lib/vcsn/dot/scan.ll"
return TOK(RBRACKET);
	YY_BREAK
case 10:
YY_RULE_SETUP
#line 62 "lib/vcsn/dot/scan.ll"
return TOK(EQ);
	YY_BREAK
case 11:
YY_RULE_SETUP
#line 63 "lib/vcsn/dot/scan.ll"
return TOK(ARROW);
	YY_BREAK
case 12:
YY_RULE_SETUP
#line 64 "lib/vcsn/dot/scan.ll"
return TOK(COLON);
	YY_BREAK
case 13:
YY_RULE_SETUP
#line 65 "lib/vcsn/dot/scan.ll"
return TOK(COMMA);
	YY_BREAK
case 14:
YY_RULE_SETUP
#line 66 "lib/vcsn/dot/scan.ll"
return TOK(SEMI);
	YY_BREAK
case 15:
YY_RULE_SETUP
#line 68 "lib/vcsn/dot/scan.ll"
loc.step(); continue;
	YY_BREAK
case 16:
YY_RULE_SETUP
#line 69 "lib/vcsn/dot/scan.ll"
BEGIN(SC_COMMENT);
	YY_BREAK
case 17:
YY_RULE_SETUP
#line 70 "lib/vcsn/dot/scan.ll"
BEGIN(SC_STRING);
	YY_BREAK
case 18:
YY_RULE_SETUP
#line 71 "lib/vcsn/dot/scan.ll"
++nesting; BEGIN(SC_XML);
	YY_BREAK
case 19:
YY_RULE_SETUP
#line 72 "lib/vcsn/dot/scan.ll"
{
...
case 20:
YY_RULE_SETUP
#line 77 "lib/vcsn/dot/scan.ll"
loc.step(); continue;
	YY_BREAK
case 21:
/* rule 21 can match eol */
YY_RULE_SETUP
#line 78 "lib/vcsn/dot/scan.ll"
LINE(yyleng); loc.step(); continue;
	YY_BREAK
case 22:
YY_RULE_SETUP
#line 79 "lib/vcsn/dot/scan.ll"
...
case 23:
YY_RULE_SETUP
#line 83 "lib/vcsn/dot/scan.ll"
loc.step(); continue;
	YY_BREAK
case 24:
YY_RULE_SETUP
#line 84 "lib/vcsn/dot/scan.ll"
loc.step(); continue;
	YY_BREAK
case 25:
/* rule 25 can match eol */
YY_RULE_SETUP
#line 85 "lib/vcsn/dot/scan.ll"
LINE(yyleng); loc.step(); continue;
	YY_BREAK
case 26:
YY_RULE_SETUP
#line 86 "lib/vcsn/dot/scan.ll"
BEGIN(INITIAL);
	YY_BREAK
...
case 28:
YY_RULE_SETUP
#line 95 "lib/vcsn/dot/scan.ll"
s.push_back(yytext[1]);
	YY_BREAK
case 29:
YY_RULE_SETUP
#line 96 "lib/vcsn/dot/scan.ll"
s.append(yytext, yyleng);
	YY_BREAK
case 30:
/* rule 30 can match eol */
YY_RULE_SETUP
#line 97 "lib/vcsn/dot/scan.ll"
LINE(yyleng); s.append(yytext, yyleng);
	YY_BREAK
case YY_STATE_EOF(SC_STRING):
#line 99 "lib/vcsn/dot/scan.ll"
{
...
/* Handling of the XML/HTML strings.  Initial < is eaten. */
case 31:
YY_RULE_SETUP
#line 107 "lib/vcsn/dot/scan.ll"
{
    if (--nesting == 0)
      {
        BEGIN(INITIAL);
...
case 32:
YY_RULE_SETUP
#line 117 "lib/vcsn/dot/scan.ll"
++nesting; s.push_back('<');
	YY_BREAK
case 33:
YY_RULE_SETUP
#line 118 "lib/vcsn/dot/scan.ll"
s.append(yytext, yyleng);
	YY_BREAK
case 34:
/* rule 34 can match eol */
YY_RULE_SETUP
#line 119 "lib/vcsn/dot/scan.ll"
LINE(yyleng); s.append(yytext, yyleng);
	YY_BREAK
case YY_STATE_EOF(SC_XML):
#line 121 "lib/vcsn/dot/scan.ll"
{
...
case 35:
YY_RULE_SETUP
#line 128 "lib/vcsn/dot/scan.ll"
ECHO;
	YY_BREAK
#line 1073 "lib/vcsn/dot/scan.cc"
